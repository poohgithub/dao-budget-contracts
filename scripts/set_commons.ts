...
async function main() {
    ...
    await issued.connect(adminSigner).setCommonsBudgetAddress(commonsBudget.address);
    console.log("CommonsBudget address:", commonsBudget.address, "set into IssuedContract:", issued.address);
}
